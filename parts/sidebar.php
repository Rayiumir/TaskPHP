    ...
    <?php if($_SESSION['role'] == "admin"){?>
        ...
        <div class="mt-3 p-3">
            <div class="d-grid gep-3">
                <a href="admin.php" class="btn btn-light text-start border-0 rounded-3 mb-2"><i class="fa-duotone fa-home me-2"></i> Dashboard </a>
                ...
                <a href="tasks.php" class="btn btn-light text-start border-0 rounded-3 mb-2 position-relative"><i class="fa-duotone fa-tasks me-2"></i> Tasks </a>
            </div>
        </div>
    <?php }else{?>
        <div class="text-center mt-3">
        ...
        <div class="mt-3 p-3">
            <div class="d-grid gep-3">
                <a href="admin.php" class="btn btn-light text-start border-0 rounded-3 mb-2"><i class="fa-duotone fa-home me-2"></i> Dashboard </a>
                <a href="" class="btn btn-light text-start border-0 rounded-3 mb-2"><i class="fa-duotone fa-bell me-2"></i> Notifications </a>
                <a href="myTasks.php" class="btn btn-light text-start border-0 rounded-3 mb-2"><i class="fa-duotone fa-tasks me-2"></i> My Tasks </a>
            </div>
        </div>
    <?php } ?>
</div>
